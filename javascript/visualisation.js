...
function drawCounties() {
  ...
  function ready(error, data) {
    ...
    g.append("g")
      ...
      .attr("fill", function(d) {
        return population_colour(
          (d.population = prevalence_data.get(d.properties.MKOOD))
        );
      });
    g.append("g")
      .attr("id", "counties")
    ...
    g.append("path")
      .datum(
        topojson.mesh(data, data.objects.maakond, function(a, b) {
          return a !== b;
        })
      )
    ...
    var legend = d3.select("svg#legend").attr("id", "legend");
  ...
  function clicked(d) {
    ...
    if (typeof d !== "undefined") {
      ...
      vue_app.current_place_confirmed = parseInt(
        d.population,
        10
      ).toLocaleString("et");
    }
  ...
  function reset() {
    ...
    vue_app.current_place_confirmed = parseInt("258").toLocaleString("et");
  }
}
...
function drawMunicipalities() {
  ...
  function ready(error, data) {
    ...
    g.append("g")
      ...
      .attr("fill", function(d) {
        return population_colour(
          (d.population = prevalence_data.get(d.properties.OKOOD))
        );
      })
      .on("click", clicked);
  ...
  function reset() {
    ...
    // TODO: Don't hard-code any values here.
    vue_app.current_place_name = "Eesti";
    vue_app.current_place_confirmed = parseInt("258").toLocaleString();
  }
}
